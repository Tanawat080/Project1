<?php
 ...
 <form  name="cal" method="post" action="confirmself.php">
...
<?php   $amount= $_POST["amount"];
   ...
   <input type="hidden" name="improve_ID" value="<?php echo $improve_ID;?>">
   ...
   <input type="hidden" name="Price" value="<?php echo $price;?>">
           ...
           <center>
             ...
             <input style="margin:auto;width:400px;" type="text" class="form-control" id="name" name="name" value="<?php echo($objResult['customer_Name']);?>" disabled=""><br>
             ...
             <input style="margin:auto;width:400px;" type="text"  class="form-control" id="tel" name="tel"  value="<?php echo($objResult['phone_No']);?>" disabled=""><br>
