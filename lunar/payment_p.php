...
<div class="" style="background-color:#CCCCFF;">
  ...
  <body>
    <form class="form-inline" method="post" action="deposit1.php" enctype="multipart/form-data">
          ...
          <div class="form-group">
    					<select name="bank">
    				 		<option value="">เลือกธนาคาร</option>
    				 			<?php
    								include ("testdb.php");
    							  $strSQL = mysqli_query($mysqli,"SELECT * FROM bank");
    							  //$objResult = mysqli_fetch_array($strSQL);
    				 						while($objResult = mysqli_fetch_array($strSQL)){
    				 			?>
    				 		<option value="<?php echo $objResult["bank_ID"];?>"><?php echo $objResult["b_Naccount"]; echo '&nbsp&nbsp';?><?php echo $objResult["b_Name"]; echo '&nbsp&nbsp';?><?php echo $objResult["b_Bank"];?></option>
...
<div class="form-group">
    			...
    			<font face = "MS Sans Serif"><input type="text" class="form-control" id="date" name="date" placeholder="วันที่ชำระเงิน"></font>
          <a href="javascript:displayDatePicker('date')">
          <img border="0" src="img/formcal.gif" width="16" height="16"></a>
</div>
    	<br><br>
    		<div class="form-group">
    			<label for="des">เวลา(โดยประมาณ) : </label>
          <font face = "MS Sans Serif"><input type="text" class="form-control" id="time" name="time" placeholder="เวลา"></font>
          </div>
    		<br><br>
    		<div class="form-group">
    			<label for="des">จำนวนเงิน : </label>
    			<font face = "MS Sans Serif"><input type="text" class="form-control" id="Price" name="Price" placeholder="จำนวนเงิน"></font>
    		</div>
    		<br><br>
    			<div class="form-group">
            <label for="des">หลักฐานการโอนเงิน : </label>
