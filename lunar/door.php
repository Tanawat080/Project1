      ...
      <form name="FrmCal" method="post" >
        ...
        <div class="figure">
          <input type="hidden" name="type_ID" value="<?php echo $objResult["product_ID"];?>">
            ...
            <font size = "3"><?php echo $objResult["Description"];?></font><br>
           <button class="button button4" type="button" onClick="this.form.action='calculate.php?product_ID=<?php echo $objResult["product_ID"];?>'; submit()"><font face = "TH SarabunPSK" >เช็คราคา</font></button>
